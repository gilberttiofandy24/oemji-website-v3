...
interface ProductPaymentMethodPickerProps {
...
const ProductPaymentMethodPicker = ({
  form,
  step,
  groups,
  basePrice,
  checkPrerequisites,
}: ProductPaymentMethodPickerProps) => {
  const selectedId = form.watch("payment_method_id");
  ...
  return (
    <StepCard step={step} title="Pilih Metode Pembayaran">
...
export default ProductPaymentMethodPicker;
